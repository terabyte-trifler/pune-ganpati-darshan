...
const DECIDER: Record<Decider, { label: string; note: string }> = {
  ...
  'dwell-only': { label: 'Phase 2 · dwell alone', note: 'Nobody reported. Two or more distinct devices agreed, so the mandal is coloured half-filled and labelled "Observed". Never worded as a report.' },
