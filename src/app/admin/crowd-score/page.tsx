...
const DECIDER: Record<Decider, { label: string; note: string }> = {
  ...
  'dwell-only': { label: 'Phase 2 · dwell alone', note: 'Nobody reported. One or more distinct devices agreed (festival-night setting; "short" still needs two), so the mandal is coloured half-filled and labelled "Observed". Never worded as a report.' },
