...
export const METRO_STATIONS: MetroStation[] = [
  ...
  },
  {
    ...
    canAlight: false,
    alightNote:
      'Coming for darshan, please use Kasba Peth and walk down — ' +
      'Tulshibaug is about 900 m from there. Mandai is your station for ' +
      'the journey home.',
    exitNote:
      'Mahatma Phule Mandai. Your station for the journey home during the ' +
      'festival — closest to the Mandai and Tulshibaug mandals, which ' +
      'makes it the easiest place to end an evening. Coming for darshan, ' +
      'please use Kasba Peth.',
  },
  {
    id: 'swargate',
    name: 'Swargate',
  ...
  { id: 'pcmc', name: 'PCMC', nameMr: 'पिंपरी चिंचवड', lines: ['purple'], lat: 18.6293185, lng: 73.8032857, tier: 'network', canAlight: false, exitNote: '' },
  { id: 'sant-tukaram-nagar', name: 'Sant Tukaram Nagar', nameMr: 'संत तुकाराम नगर', lines: ['purple'], lat: 18.6145248, lng: 73.8157455, tier: 'network', canAlight: false, exitNote: '' },
  { id: 'bhosari', name: 'Bhosari', nameMr: 'भोसरी', lines: ['purple'], lat: 18.609303, lng: 73.8200965, tier: 'network', canAlight: false, exitNote: '' },
  { id: 'kasarwadi', name: 'Kasarwadi', nameMr: 'कासारवाडी', lines: ['purple'], lat: 18.5996201, lng: 73.8272644, tier: 'network', canAlight: false, exitNote: '' },
  { id: 'phugewadi', name: 'Phugewadi', nameMr: 'फुगेवाडी', lines: ['purple'], lat: 18.5911058, lng: 73.8311472, tier: 'network', canAlight: false, exitNote: '' },
  { id: 'dapodi', name: 'Dapodi', nameMr: 'दापोडी', lines: ['purple'], lat: 18.5837649, lng: 73.8337656, tier: 'network', canAlight: false, exitNote: '' },
  { id: 'bopodi', name: 'Bopodi', nameMr: 'बोपोडी', lines: ['purple'], lat: 18.5696611, lng: 73.8381029, tier: 'network', canAlight: false, exitNote: '' },
  { id: 'khadki', name: 'Khadki', nameMr: 'खडकी', lines: ['purple'], lat: 18.5622619, lng: 73.8420825, tier: 'network', canAlight: false, exitNote: '' },
  { id: 'range-hills', name: 'Range Hills', nameMr: 'रेंज हिल्स', lines: ['purple'], lat: 18.5502871, lng: 73.8458072, tier: 'network', canAlight: false, exitNote: '' },
  { id: 'shivajinagar', name: 'Shivajinagar', nameMr: 'शिवाजीनगर', lines: ['purple'], lat: 18.5304747, lng: 73.8485711, tier: 'network', canAlight: false, exitNote: '' },

  /* ---------------- Aqua Line, west of Deccan ---------------- */
  { id: 'vanaz', name: 'Vanaz', nameMr: 'वनाझ', lines: ['aqua'], lat: 18.5071853, lng: 73.8051948, tier: 'network', canAlight: false, exitNote: '' },
  { id: 'anand-nagar', name: 'Anand Nagar', nameMr: 'आनंद नगर', lines: ['aqua'], lat: 18.5095724, lng: 73.8140749, tier: 'network', canAlight: false, exitNote: '' },
  { id: 'ideal-colony', name: 'Ideal Colony', nameMr: 'आयडियल कॉलनी', lines: ['aqua'], lat: 18.508885, lng: 73.822144, tier: 'network', canAlight: false, exitNote: '' },
  { id: 'nal-stop', name: 'Nal Stop', nameMr: 'नळ स्टॉप', lines: ['aqua'], lat: 18.5073567, lng: 73.8287815, tier: 'network', canAlight: false, exitNote: '' },
  ...
  { id: 'kalyani-nagar', name: 'Kalyani Nagar', nameMr: 'कल्याणी नगर', lines: ['aqua'], lat: 18.5444806, lng: 73.9056979, tier: 'network', canAlight: false, exitNote: '' },
  { id: 'ramwadi', name: 'Ramwadi', nameMr: 'रामवाडी', lines: ['aqua'], lat: 18.557028, lng: 73.9085628, tier: 'network', canAlight: false, exitNote: '' },
];
